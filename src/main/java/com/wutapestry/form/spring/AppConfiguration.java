package com.wutapestry.form.spring;
...
@Configuration
@ComponentScan({ "com.wutapestry.form" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.wutapestry.form");
                servletContext.setInitParameter("tapestry.development-modules", "com.wutapestry.form.services.DevelopmentModule");
